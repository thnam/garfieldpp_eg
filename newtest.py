...
ex2 = ll[0].Extrude([0,0,3], index = 2)
p.AddList(ex2['points'])
l.AddList(ex2['curves'])
ll.AddList(ex2['lineloops'])
sf.AddList(ex2['surfaces'])
#sl.AddList(ex2['surfaceloops'])
#vl.AddList(ex2['volumes'])
